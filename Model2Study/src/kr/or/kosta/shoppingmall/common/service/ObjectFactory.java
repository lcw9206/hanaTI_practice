			...
			while (iter.hasNext()) {
				...
				if (parsedText.length > 1) {
					...
					if (type.equals("dao")) {
						...
						System.out.println(daoName + "Class : " + daoClassName);
				...
				if (parsedText.length > 1) {
					...
					if (type.equals("service")) {
						...
						if (parsedServiceName.length == 2) {
							...
							System.out.println(daoName + " =  m : " + methodName);
...
//								method = cls.getMethod(methodName, UserDao.class);
	...
	public static void main(String[] args) throws Exception {
		String mapperLocation = "/Users/mcbookpro/Java/workspace/Model2Study/WebContent/WEB-INF/object-mapper.properties";
